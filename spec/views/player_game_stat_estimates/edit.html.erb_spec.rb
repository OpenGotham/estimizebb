...
describe "player_game_stat_estimates/edit.html.erb" do
  before(:each) do
  ...
  it "renders the edit player_game_stat_estimate form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => player_game_stat_estimates_path(@player_game_stat_estimate), :method => "post" do
